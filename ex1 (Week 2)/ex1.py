...
import pandas as pd              #Reading CSV, Text,SQL, other files and using Queries on the datafrmes ( The object storing data in it)
import numpy as np               #Mathematical computation model
...
# answers to assignment questions for univariate linear regression

print(cost(X, Y, Theta))     # computing cost for theta = [0, 0], gives result 32.07
print(np.dot([1,3.5],Theta_Iterated), np.dot([1,7], Theta_Normal))
